...
#upload code to idio me ton prwto apla anebazoyme ta ananeomena dedomena meta tin leiyourgia tou task_3_main.py

#To kratame giati etsi fortwsame ta arxeia wste na to deiksoyme sthn anafora
'''
with open("Neural-Final-Updated-Ratings.csv") as x:
    reader = csv.DictReader(x)
    helpers.bulk(es, reader, index="neural_final_updated_ratings")
'''
...
for y in range (len(books_final)):
    ...
    ratings_query_results = scan(es,
        index="neural_final_updated_ratings",
        preserve_order=True,
